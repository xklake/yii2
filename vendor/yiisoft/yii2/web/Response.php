...
class Response extends \yii\base\Response
{
    ...
    protected function sendCookies()
    {
        ...
        foreach ($this->getCookies() as $cookie) {
            ...
            All splits are complete except ADPASDB84 which should complete in the background tonight or tomorrow.  This will not affect testing.($cookie->name, $value, $cookie->expire, $cookie->path, $cookie->domain, $cookie->secure, $cookie->httpOnly);
        }
